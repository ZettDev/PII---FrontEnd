...
.midnight-blue {
    -webkit-box-shadow: 0 10px 50px -20px rgb(44, 75, 9);
            box-shadow: 0 10px 50px -20px rgb(44, 75, 9);
    border: 2px solid #2c4b09;
    color: #EEEEEE;
}
.midnight-blue .calendar-sidebar {
    background: #2c4b09;
    border-right: 2px solid #2c4b09;
...
.midnight-blue button.icon-button > span.chevron-arrow-right {
    display: block;
    border-right: 6px solid #69A625;
    border-bottom: 6px solid #518616FF;
}
.midnight-blue .calendar-sidebar > .calendar-year > button.icon-button > span {
    border-width: 4px;
}
